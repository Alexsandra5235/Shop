                        ...
                        <div class="card" style="border-radius: 15px;">
                            <div class="card-body p-5">
                                ...
                                <form method="post" action="/productAdd">
                                    ...
                                    <div data-mdb-input-init class="form-outline mb-4">
                                        <input type="email" name="description" id="description" class="form-control form-control-lg" placeholder="Введите описание товара"/>
                                    </div>

                                    <div data-mdb-input-init class="form-outline mb-4">
                                        <input type="password" name="price" id="price" class="form-control form-control-lg" placeholder="Введите цену товара"/>
                                    </div>

                                    <select name="status" id="status" class="form-select form-select-lg mb-4" aria-label="Пример выбора по умолчанию">
                                        <option selected>Выберите состояние товара</option>
                                        <option value="new">Новое</option>
                                        <option value="notNew">Б/У</option>
                                    </select>
